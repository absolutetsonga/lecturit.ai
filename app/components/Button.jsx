...
const variantStyles = {
    ...
    outline: {
        slate: 'ring-slate-200 text-slate-700 dark:text-slate-100 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300',
