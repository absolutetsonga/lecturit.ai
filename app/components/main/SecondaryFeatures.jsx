...
import screenshotContacts from '@/app/images/screenshots/contacts.png';
import screenshotInventory from '@/app/images/screenshots/inventory.png';
import screenshotProfitLoss from '@/app/images/screenshots/profit-loss.png';
        ...
        >
            <div
                className={clsx(
                    'w-9 rounded-lg',
                    isActive
                        ? 'bg-blue-600 dark:bg-violet-400'
                        : 'bg-slate-500',
                )}
            >
        ...
        <Tab.Group as="div" className="hidden lg:mt-20 lg:block">
            {({ selectedIndex }) => (
                <>
                    ...
                    <Tab.Panels className="relative mt-20 overflow-hidden rounded-4xl bg-slate-200 px-14 py-16 dark:bg-slate-700 xl:px-16">
